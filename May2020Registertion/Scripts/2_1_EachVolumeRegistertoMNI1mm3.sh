...
do
	...
	do
		...
		invol+="/T1w_acpc_dc_restore_1mm_brain_FLIRT_MNI152_T1_1mm_brain.nii.gz"

		outvol="/home/gpu/Data/Prabhjot/LowLowerLowest/May2020Registertion/$inputt"
		outvol+="/T1w_FNIRT_FLIRT_MNI152_T1_1mm_brain.nii.gz"
		...
		fnirt --ref=$refvol --in=$invol --iout=$outvol
