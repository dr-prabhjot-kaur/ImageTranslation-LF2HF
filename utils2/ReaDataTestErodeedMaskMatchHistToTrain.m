function [x,y]  =       ReaDataTestErodeedMaskMatchHistToTrain(slicenumber,erosion,matchHist)
    [xtrain,ytrain] =       ReaData(slicenumber);
    ...
    if matchHist==1
        y=255.*imhistmatch(mat2gray(y),mat2gray(ytrain));
        x=255.*imhistmatch(mat2gray(x),mat2gray(xtrain));
    end
end
